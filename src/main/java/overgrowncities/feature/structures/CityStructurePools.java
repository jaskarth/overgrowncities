...
public class CityStructurePools {
    static {
		...
		ImmutableList<StructureProcessor> destructionRules = ImmutableList.of(new RuleStructureProcessor(ImmutableList.of(
				...
				//place end stone or ende stone brick for where you want extra debris to be placed in the building (on the floor usually)
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.18F), AlwaysTrueRuleTest.INSTANCE, Blocks.STONE_PRESSURE_PLATE.getDefaultState()),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.01F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE_STAIRS.getDefaultState().with(StairsBlock.HALF, BlockHalf.BOTTOM).with(StairsBlock.FACING, Direction.NORTH)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.01F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE_STAIRS.getDefaultState().with(StairsBlock.HALF, BlockHalf.BOTTOM).with(StairsBlock.FACING, Direction.WEST)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.01F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE_STAIRS.getDefaultState().with(StairsBlock.HALF, BlockHalf.BOTTOM).with(StairsBlock.FACING, Direction.SOUTH)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.01F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE_STAIRS.getDefaultState().with(StairsBlock.HALF, BlockHalf.BOTTOM).with(StairsBlock.FACING, Direction.EAST)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.06F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE_SLAB.getDefaultState()),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.02F), AlwaysTrueRuleTest.INSTANCE, Blocks.ANDESITE.getDefaultState()),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.12F), AlwaysTrueRuleTest.INSTANCE, Blocks.STONE_BUTTON.getDefaultState().with(StoneButtonBlock.FACE, WallMountLocation.FLOOR).with(StoneButtonBlock.FACING, Direction.NORTH)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 0.12F), AlwaysTrueRuleTest.INSTANCE, Blocks.STONE_BUTTON.getDefaultState().with(StoneButtonBlock.FACE, WallMountLocation.FLOOR).with(StoneButtonBlock.FACING, Direction.EAST)),
				new StructureProcessorRule(new RandomBlockMatchRuleTest(Blocks.END_STONE_BRICKS, 1F), AlwaysTrueRuleTest.INSTANCE, Blocks.AIR.getDefaultState()), //remove excess remaining end stone bricks
